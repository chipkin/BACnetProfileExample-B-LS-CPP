...
<!-- METRICS -->
| Platform | Binary | Size | Start-up to `ready` | Stack commit |
|---|---|---|---|---|
| Windows x64 (windows-2022) | `BACnetExampleBLS.exe` | 3,272,704 bytes (~3.1 MiB) | 70 ms | `abd4cee1` |
| Linux x64 (ubuntu-latest) | `BACnetExampleBLS` | 54,944 bytes (~54 KiB) | 115 ms | `abd4cee1` |

v1.0.0 was published from a prebuilt STATIC stack library rather than the SOURCE
build documented above; the next release refreshes these numbers from the
documented build.
